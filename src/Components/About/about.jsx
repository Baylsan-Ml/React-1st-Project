        ...
        <div className="container mt-2">
            <div className="row justify-content-center">
                <div className="col-md-4 ms-auto text-light">
                    <p className={style.lead}>Freelancer is a free bootstrap theme created by Start Bootstrap. 
                ...
                <div className='mt-4'>
                    <a className={`${style.downlodBtn} btn btn-xl btn-outline-light rounded-2`} href="">
